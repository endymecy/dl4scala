...
public class MLPClassifierMoon {
    ...
    public static void main(String[] args) throws Exception {
        ...
        rr.initialize(new FileSplit(new File("dl4scala-examples/src/main/resources/classification/moon_data_train.csv")));
        DataSetIterator trainIter = new RecordReaderDataSetIterator(rr,batchSize,0,2);

        //Load the test/evaluation data:
        RecordReader rrTest = new CSVRecordReader();
        rrTest.initialize(new FileSplit(new File("dl4scala-examples/src/main/resources/classification/moon_data_eval.csv")));
